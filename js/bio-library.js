window.ZpropBioLibrary = {
  mount({base,publishBase,t,label,esc,initialState,onSelect}) {
    ...
    const urlFor=slug=>new URL(`/${slug}/`,publishBase).href;
